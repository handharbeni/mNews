package illiyin.mhandharbeni.databasemodule.model.mnews.response.data.get_search_post;
...
public class DataSearchPost extends RealmObject {
    @SerializedName("id")
    @Expose
    private Integer id;
