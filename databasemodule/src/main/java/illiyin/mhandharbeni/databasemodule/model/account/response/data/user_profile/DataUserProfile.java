...
public class DataUserProfile {
    ...
    @Expose
    private DataUserProfileAlamat alamatPribadi;
    @SerializedName("kota")
    @Expose
    ...
    public DataUserProfileAlamat getAlamatPribadi() {
        return alamatPribadi;
    }

    public void setAlamatPribadi(DataUserProfileAlamat alamatPribadi) {
